...
const config: Config = {
  ...
  url: 'https://petitorium.github.io',
  baseUrl: '/',

  organizationName: 'petitorium',
  projectName: 'petitorium-site',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/petitorium/petitorium',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/petitorium/petitorium/issues',
            },
          ],
        },
        {
